...
<div class="bg-primary text-white py-5 mb-5 rounded-3 shadow">
    <div class="container">
        <h1 class="display-5 fw-bold"><i class="fas fa-graduation-cap me-2"></i>歡迎來到課程管理系統</h1>
        <p class="fs-4">探索課程、參與投票，提升您的學習體驗</p>
...
<!-- 課程區段 -->
<h2 class="mb-4"><i class="fas fa-book me-2"></i>最新課程</h2>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <c:if test="${not empty course.courseFiles}">
                            <small class="text-body-secondary">
                                <i class="fas fa-file me-1"></i>${course.courseFiles.size()} 個檔案
                            </small>
                        </c:if>
                        <small class="text-body-secondary">
                            <i class="fas fa-comments me-1"></i>${course.comments.size()} 條評論
                        </small>
                    </div>
                </div>
...
<!-- 投票區段 -->
<h2 class="mb-4"><i class="fas fa-poll me-2"></i>最新投票</h2>
<div class="row g-4">
